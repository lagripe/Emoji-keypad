...
namespace Emojis
{
  ...
  static public class cEventHelper
  {
    ...
    //--------------------------------------------------------------------------------
    public static List<FieldInfo> GetTypeEventFields(Type t)
    {
    ...
    //--------------------------------------------------------------------------------
    public static void BuildEventFields(Type t, List<FieldInfo> lst)
    {
...
/*
    ...
    //--------------------------------------------------------------------------------
    public static EventHandlerList GetStaticEventHandlerList(Type t, object obj)
    {
